...
CREATE TABLE users (
    ...
    user_type INT NOT NULL, -- 0 = employee, 1 = member
    first_name VARCHAR(50) NOT NULL,
    last_name VARCHAR(50) NOT NULL,
    start_date DATE NOT NULL,
    end_date DATE,
    cookie_value VARCHAR(255),
    cookie_expiration_time TIMESTAMP,
    active_flag TINYINT(1) DEFAULT 1  -- <--- ADDED HERE (1 = Active, 0 = Inactive)
);

INSERT INTO `users` (`user_id`, `user_name`, `user_password`, `user_type`, `first_name`, `last_name`, `start_date`, `active_flag`) VALUES
  (1, 'cramirez', 'tiger', 0, 'Christopher', 'Ramirez', '2026-01-25', 1),
  (2, 'sking', 'lion', 0, 'Shelly', 'King', '2026-02-01', 1),
  (3, 'thughes', 'carrot', 0, 'Tiffany', 'Hughes', '2026-02-15', 1),
  (4, 'hbarber', 'apple', 0, 'Holly', 'Barber', '2026-03-01', 1),
  (5, 'telliott', 'lemon', 0, 'Theresa', 'Elliott', '2026-03-15', 1),
  (6, 'jwarren', 'tomato', 0, 'Jacob', 'Warren', '2026-04-15', 1),
  (7, 'tramirez', 'rabbit', 0, 'Tammie', 'Ramirez', '2026-05-01', 1),
  (8, 'ajohnson', 'wolf', 0, 'Allison', 'Johnson', '2026-05-15', 1),
  (9, 'mbell', 'peach', 0, 'Melody', 'Bell', '2026-06-01', 1),
  (10, 'nadams', 'banana', 0, 'Nancy', 'Adams', '2026-06-15', 1),
  (11, 'jallen', 'orange', 1, 'Jonathan', 'Allen', '2026-07-01', 1),
  (12, 'abutler', 'pinapple', 1, 'Ashley', 'Butler', '2026-07-05', 1),
  (13, 'nstewart', 'cucumber', 1, 'Nicholas', 'Stewart', '2026-06-10', 1),
  (14, 'jpatterson', 'pepper', 1, 'Juan', 'Patterson', '2026-05-01', 1),
  (15, 'tmiller', 'deer', 1, 'Taylor', 'Miller', '2026-04-15', 1),
  (16, 'aberg', 'kangaroo', 1, 'Allison', 'Berg', '2026-04-25', 1),
  (17, 'kanderson', 'kitten', 1, 'Kevin', 'Anderson', '2026-04-08', 1),
  (18, 'dchang', 'iguana', 1, 'Douglas', 'Chang', '2026-03-20', 1),
  (19, 'sthomas', 'lizard', 1, 'Stephen', 'Thomas', '2026-03-01', 1),
  (20, 'lortiz', 'snail', 1, 'Luis', 'Ortiz', '2024-03-20', 0); -- Set Luis Ortiz to Inactive (0)
...
CREATE TABLE members (
    ...
    goals TEXT,
    health_notes TEXT,
    -- active_flag TINYINT(1) DEFAULT 1  <--- REMOVED FROM HERE
    FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE
);

INSERT INTO `members` VALUES
  (11, 'improve physical fitness', 'myopia'),
  (12, 'prepare for military service', 'healthy'),
  (13, 'strengthen muscles', 'recent fracture of the left arm'),
  (14, 'build abs', 'healthy'),
  (15, 'improve physical fitness', 'flat feet'),
  (16, 'get into a sport science program', 'healthy'),
  (17, 'lose weight', 'hypertension'),
  (18, 'earn the title of Master of Sport', 'healthy'),
  (19, 'impove physical fitness', 'valgus deformity of the feet'),
  (20, 'build muscle', 'healthy');
...
INSERT INTO `requests` (`request_type`, `request_text`, `request_date`, `target_date`) VALUES
  (0, 'Sick leave, need to cancel', '2026-07-01', '2026-07-10'),          -- 0 = Cancel
  (1, 'Would like to co-coach this class', '2026-06-25', '2026-07-01'),   -- 1 = Join
  (2, 'Schedule conflict, need to leave group', '2026-07-02', '2026-08-01'), -- 2 = Leave
  (1, 'Available to take over', '2026-07-03', '2026-07-15'),             -- 1 = Join
  (0, 'Facility issue', '2026-07-04', '2026-07-11'),                     -- 0 = Cancel
  (1, 'Interested in taking this shift', '2026-07-05', '2026-07-20'),    -- 1 = Join
  (2, 'Moving to a different location', '2026-06-15', '2026-07-31'),     -- 2 = Leave
  (1, 'I can cover this class', '2026-07-06', '2026-07-14'),              -- 1 = Join
  (0, 'Personal emergency', '2026-07-05', '2026-07-08'),                  -- 0 = Cancel
  (1, 'I will cover the sick leave', '2026-07-02', '2026-07-10');         -- 1 = Join
