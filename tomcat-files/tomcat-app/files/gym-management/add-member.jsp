...
<body>
	...
	if (password1.equals(password2) && !password1.equals("")) {
		...
		if (getid_res.next()) {
		    ...
		    + "cookie_value, "
		    + "cookie_expiration_time) VALUES(?, ?, ?, 1, ?, ?, ?, "
		    + "null, null, null)";
		    ...
		    insert_memb_stmt.setInt(5, (active_flag != null) ? 1 : 0);
	...
	<form action="add-member.jsp" method="get">
		...
		<textarea id="health_notes" name="health_notes" readonly
			  rows="3"><%= health_notes %></textarea>
	    </div>
	    <div class="form-row">
		<label class="result">Goals:</label>
		<textarea id="goals" name="goals" readonly
			  rows="3"><%= goals %></textarea>
	    </div>
	    <div class="form-row">
		<label class="result">Last name:</label>
		<label class="result_value"><%= lname %></label>
	    ...
	    <div class="form-row">
		<label class="result"><%
		if (active_flag != null) out.print("Active");
		   else out.print("INACTIVE"); %></label>
	    </div>
	    <button type="submit" class="btn"
		    style="width: 100%;">Add another member</button>
	</form>
    </div>
    <%
		    con.commit();
	...
	<div class="card container-input">
		...
		<div class="form-row">
		    <input id="active_flag" name="active_flag" type="checkbox"
			   value="active_flag"
		    <% if (active_flag != null) out.print("checked"); %> />
